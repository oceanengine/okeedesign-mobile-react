...
export interface SortIconProps extends React.HTMLAttributes<SVGElement> {
  sortType: TableSortType;
}

const bem = createBEM('sort-icon');
...
function SortIcon(props: SortIconProps): JSX.Element {
  ...
  return (
    ...
    >
      <path
        className={bem([{ active: sortType === 'asc' }])}
      ...
      />
      <path
        className={bem([{ active: sortType === 'desc' }])}
