...
export type TableRenderTdCellType = (rowData: unknown, column: TableColumnProps) => RenderContent;

export type TableRenderThCellType = (column: TableColumnProps) => RenderContent;
...
export interface TableExpandOptionsType extends BaseTableColumnProps {
  ...
  renderIcon?: (rowData: Record<string, any>) => RenderContent;
  // 展开的区域内容的自定义渲染函数
  renderContent: (rowData: Record<string, any>) => RenderContent;
}
